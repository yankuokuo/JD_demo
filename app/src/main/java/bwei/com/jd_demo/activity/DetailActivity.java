...
public class DetailActivity extends AppCompatActivity implements ILoginView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pid = intent.getIntExtra("tuipid",0);
        Log.d("传过来的pid","pid+++++"+ pid);
        Log.d("传过来的searpid","searpid+++++"+ searpid);
            homePersenter.detailLogin(pid);
    }
    ...
    public void onViewClicked() {
        ...
        homePersenter.addLogin(uid,pid);
    ...
    public void CarLogin(View view) {
    }
